...
#define __OpenHRP_msonyService__
  ...
  public:
    ...
    void setFootPosR();
    void setFootPosL();
    void setFootPosR2(::CORBA::Double x, ::CORBA::Double y, ::CORBA::Double z, ::CORBA::Double r, ::CORBA::Double p, ::CORBA::Double w);
    void setFootPosL2(::CORBA::Double x, ::CORBA::Double y, ::CORBA::Double z, ::CORBA::Double r, ::CORBA::Double p, ::CORBA::Double w);
  ...
  public:
    ...
    virtual void setFootPosR2(::CORBA::Double x, ::CORBA::Double y, ::CORBA::Double z, ::CORBA::Double r, ::CORBA::Double p, ::CORBA::Double w) = 0;
    virtual void setFootPosL2(::CORBA::Double x, ::CORBA::Double y, ::CORBA::Double z, ::CORBA::Double r, ::CORBA::Double p, ::CORBA::Double w) = 0;
