...
void OpenHRP::_objref_sonyService::setFootPosR()
{
  _0RL_cd_457ccd98b3f23528_00000000 _call_desc(_0RL_lcfn_457ccd98b3f23528_70000000, "setFootPosR", 12);
...
void OpenHRP::_objref_sonyService::setFootPosL()
{
  _0RL_cd_457ccd98b3f23528_00000000 _call_desc(_0RL_lcfn_457ccd98b3f23528_80000000, "setFootPosL", 12);
...
_0RL_lcfn_457ccd98b3f23528_90000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_457ccd98b3f23528_20000000* tcd = (_0RL_cd_457ccd98b3f23528_20000000*)cd;
  OpenHRP::_impl_sonyService* impl = (OpenHRP::_impl_sonyService*) svnt->_ptrToInterface(OpenHRP::sonyService::_PD_repoId);
  impl->setFootPosR2(tcd->arg_0, tcd->arg_1, tcd->arg_2, tcd->arg_3, tcd->arg_4, tcd->arg_5);


}

void OpenHRP::_objref_sonyService::setFootPosR2(::CORBA::Double x, ::CORBA::Double y, ::CORBA::Double z, ::CORBA::Double r, ::CORBA::Double p, ::CORBA::Double w)
{
  _0RL_cd_457ccd98b3f23528_20000000 _call_desc(_0RL_lcfn_457ccd98b3f23528_90000000, "setFootPosR2", 13);
  _call_desc.arg_0 = x;
  _call_desc.arg_1 = y;
  _call_desc.arg_2 = z;
  _call_desc.arg_3 = r;
...
_0RL_lcfn_457ccd98b3f23528_a0000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_457ccd98b3f23528_20000000* tcd = (_0RL_cd_457ccd98b3f23528_20000000*)cd;
  OpenHRP::_impl_sonyService* impl = (OpenHRP::_impl_sonyService*) svnt->_ptrToInterface(OpenHRP::sonyService::_PD_repoId);
  impl->setFootPosL2(tcd->arg_0, tcd->arg_1, tcd->arg_2, tcd->arg_3, tcd->arg_4, tcd->arg_5);


}

void OpenHRP::_objref_sonyService::setFootPosL2(::CORBA::Double x, ::CORBA::Double y, ::CORBA::Double z, ::CORBA::Double r, ::CORBA::Double p, ::CORBA::Double w)
{
  _0RL_cd_457ccd98b3f23528_20000000 _call_desc(_0RL_lcfn_457ccd98b3f23528_a0000000, "setFootPosL2", 13);
  _call_desc.arg_0 = x;
  _call_desc.arg_1 = y;
  _call_desc.arg_2 = z;
  _call_desc.arg_3 = r;
...
OpenHRP::_impl_sonyService::_dispatch(omniCallHandle& _handle)
{
  ...
  if( omni::strMatch(op, "setFootPosR") ) {
    ...
    _0RL_cd_457ccd98b3f23528_00000000 _call_desc(_0RL_lcfn_457ccd98b3f23528_70000000, "setFootPosR", 12, 1);
  ...
  if( omni::strMatch(op, "setFootPosL") ) {
    ...
    _0RL_cd_457ccd98b3f23528_00000000 _call_desc(_0RL_lcfn_457ccd98b3f23528_80000000, "setFootPosL", 12, 1);
  ...
  if( omni::strMatch(op, "setFootPosR2") ) {
    ...
    _0RL_cd_457ccd98b3f23528_20000000 _call_desc(_0RL_lcfn_457ccd98b3f23528_90000000, "setFootPosR2", 13, 1);
  ...
  if( omni::strMatch(op, "setFootPosL2") ) {
    ...
    _0RL_cd_457ccd98b3f23528_20000000 _call_desc(_0RL_lcfn_457ccd98b3f23528_a0000000, "setFootPosL2", 13, 1);
